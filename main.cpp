...
int main()
{
   ...
   /*for(int c=0;c<10;c++)
    ...
    /*for(int c=0;c<1000;c++)
    {
        ...
        cout<<"tabla "<<x<<endl;
        Registro * r= new Registro(mtablas->buscarTabla(x)->getLongitudRegistros());
        string id="id";
        string name="nombre";
        char edad= (char) (c+48);
        ostringstream nomb;
        ...
        CampoDatos * d1=new CampoDatos(i,mtablas->buscarTabla(x)->campos->get(0));
        CampoDatos * d2=new CampoDatos(nom,mtablas->buscarTabla(x)->campos->get(1));
        CampoDatos * d3=new CampoDatos(e,mtablas->buscarTabla(x)->campos->get(2));
        r->campoDatos->add(d1);
        r->campoDatos->add(d2);
        r->campoDatos->add(d3);
   ...
   //db->mTablas->buscarTabla(0)->toString();
    ...
    b->cargar();
    b->listarElementos();//*/
   //mtablas->buscarTabla(0)->buscarRegistro("id_700")->printRegistro();
